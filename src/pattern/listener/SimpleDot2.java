 ...
 */
public class SimpleDot2 extends ListenerAdapter {
  ...
  public SimpleDot2( Config config, JPF jpf){
  ...
  protected String getNextCG(){
    ...
    System.out.println(insn.getMnemonic());
  ...
  protected String getNativeExecCG (EXECUTENATIVE insn){
    ...
    String s = mi.getName();
    System.out.println("execute-native " + s);
